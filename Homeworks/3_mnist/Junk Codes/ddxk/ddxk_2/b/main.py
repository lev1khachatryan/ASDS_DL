...
# Datasets
tf.app.flags.DEFINE_string('train_images_dir', '/home/student/Desktop/Mariam/data/train', 'Training images data directory.')
tf.app.flags.DEFINE_string('val_images_dir', '/home/student/Desktop/Mariam/data/val', 'Validation images data directory.')
tf.app.flags.DEFINE_string('test_images_dir', '/home/student/Desktop/Mariam/data/test', 'Testing images data directory.')
...
tf.app.flags.DEFINE_string('base_dir', '/home/student/Desktop/Mariam/results', 'Directory in which results will be stored.')
