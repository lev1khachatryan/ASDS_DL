...
tf.app.flags.DEFINE_integer('width_of_image', 28, 'Width of the images.')
...
tf.app.flags.DEFINE_float('keep_prob', 0.2, 'Keeping probability with dropout regularization')
